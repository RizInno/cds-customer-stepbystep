# Foundation - Data Model and Odata Service
This section will cover the creation of the core CAP project, the creation of a simple data model and the creation of a simple OData service making the data model accessible. 
